...
export class TradeLinkCCIPV1__decodeMessagePayloadResultDecodedStruct extends ethereum.Tuple {
  ...
  get fulfillInfo(): TradeLinkCCIPV1__decodeMessagePayloadResultDecodedFulfillInfoStruct {
    return changetype<
      TradeLinkCCIPV1__decodeMessagePayloadResultDecodedFulfillInfoStruct
    >(this[3].toTuple());
  }
}

export class TradeLinkCCIPV1__decodeMessagePayloadResultDecodedFulfillInfoStruct extends ethereum.Tuple {
  get offerId(): BigInt {
    return this[0].toBigInt();
  }
...
export class TradeLinkCCIPV1__encodedMessagePayloadInput_messagePayloadStruct extends ethereum.Tuple {
  ...
  get fulfillInfo(): TradeLinkCCIPV1__encodedMessagePayloadInput_messagePayloadFulfillInfoStruct {
    return changetype<
      TradeLinkCCIPV1__encodedMessagePayloadInput_messagePayloadFulfillInfoStruct
    >(this[3].toTuple());
  }
}

export class TradeLinkCCIPV1__encodedMessagePayloadInput_messagePayloadFulfillInfoStruct extends ethereum.Tuple {
  get offerId(): BigInt {
    return this[0].toBigInt();
  }
...
export class TradeLinkCCIPV1__getFeeFulfillOfferInput_messagePayloadStruct extends ethereum.Tuple {
  ...
  get fulfillInfo(): TradeLinkCCIPV1__getFeeFulfillOfferInput_messagePayloadFulfillInfoStruct {
    return changetype<
      TradeLinkCCIPV1__getFeeFulfillOfferInput_messagePayloadFulfillInfoStruct
    >(this[3].toTuple());
  }
}

export class TradeLinkCCIPV1__getFeeFulfillOfferInput_messagePayloadFulfillInfoStruct extends ethereum.Tuple {
  get offerId(): BigInt {
    return this[0].toBigInt();
  }
...
export class TradeLinkCCIPV1 extends ethereum.SmartContract {
  ...
  decodeMessagePayload(
    ...
    let result = super.call(
      "decodeMessagePayload",
      "decodeMessagePayload(bytes):((uint256,uint256,uint256,(uint256,uint64,address,address[],uint256[],address[],uint256[],address,address,address,bool,bool)))",
      [ethereum.Value.fromBytes(encodedData)]
    );
  ...
  encodedMessagePayload(
    ...
    let result = super.call(
      "encodedMessagePayload",
      "encodedMessagePayload((uint256,uint256,uint256,(uint256,uint64,address,address[],uint256[],address[],uint256[],address,address,address,bool,bool))):(bytes)",
  ...
  getFeeFulfillOffer(
    ...
    let result = super.call(
      "getFeeFulfillOffer",
      "getFeeFulfillOffer((uint256,uint256,uint256,(uint256,uint64,address,address[],uint256[],address[],uint256[],address,address,address,bool,bool))):(uint256)",
      [ethereum.Value.fromTuple(_messagePayload)]
    );
  ...
  getFeeOffer(
    ...
    _ccipAddress: Address,
    _ccipAmount: BigInt
  ): BigInt {
    let result = super.call(
      "getFeeOffer",
      "getFeeOffer(uint256,uint64,address,address,address,uint256):(uint256)",
      [
        ...
        ethereum.Value.fromAddress(_ccipAddress),
        ethereum.Value.fromUnsignedBigInt(_ccipAmount)
      ]
    );
